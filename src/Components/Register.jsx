          ...
          <form onSubmit={handleSubmit}>
            <div className="user-details">
              ...
              <div className="input-box">
                ...
                />
                <span className="text-danger">
                  {registerInput.error_list.date_of_birth}
                </span>
              </div>
              <div className="input-box">
                <span className="details">
                ...
                />
                <span className="text-danger">
                  {registerInput.error_list.designation}
                </span>
              </div>
              <div className="input-box">
                <span className="details">
                ...
                />
                <span className="text-danger">
                  {registerInput.error_list.department}
                </span>
              </div>
              ...
              <div className="input-box">
                ...
                />
                <span className="text-danger">
                  {registerInput.error_list.image}
                </span>
              </div>
              ...
              <div className="input-box">
                ...
                <span className="text-danger">
                  {registerInput.error_list.blood_group}
                </span>
              </div>
              <div className="input-box">
                <span className="details">
