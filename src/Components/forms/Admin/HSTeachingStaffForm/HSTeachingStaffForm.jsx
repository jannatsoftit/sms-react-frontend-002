...
const HSTeachingStaffForm = () => {
  ...
  // hsteachingStaff info create function
            ...
            <div className='col-xl-7 col-lg-8 col-md-9 col-11 text-center'>
              <div className='card'>
                ...
                <div className='col-md-6 text-center mb-5'>
                  <h2 className='heading-section'>HS Teaching Staff Table</h2>
                ...
                {/* HS Teaching Staff create form table*/}
...
export default HSTeachingStaffForm;
