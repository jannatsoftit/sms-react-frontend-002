...
const SubjectEdit = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (confirm(`Are you sure you want to update your information?`)) {
      ...
      formData.append('class', subject.class);
      formData.append('subject_code', subject.subject_code);
      formData.append('paper', subject.paper);
              ...
              <div className='col-xl-7 col-lg-8 col-md-9 col-11 text-center'>
                <div className='card'>
                  ...
                  <div className='col-md-6 text-center mb-5'>
                    <h2 className='heading-section'>Subject Form Edit Table</h2>
